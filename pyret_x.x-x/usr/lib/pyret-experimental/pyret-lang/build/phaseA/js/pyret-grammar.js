...
R(['fs', 'jglr/jglr'], function(fs, E) {
  ...
  g.addRule("prelude", [new Nonterm("prelude_I0?"), new Nonterm("prelude_I1?"), new Nonterm("prelude_I2*")])
  ...
  g.addRule("prelude_I1?", [new Nonterm("prelude_I1")], E.Rule.Inline);
  g.addRule("prelude_I1", [new Nonterm("provide-types-stmt")], E.Rule.Inline)
  g.addRule("prelude_I2*", [], E.Rule.Inline);
  g.addRule("prelude_I2*", [new Nonterm("prelude_I2*"), new Nonterm("prelude_I2")], E.Rule.ListSnoc("prelude_I2*", "prelude_I2", true));
  ...
  g.addRule("check-test", [new Nonterm("binop-expr"), new Nonterm("check-op"), new Nonterm("check-test_A0_I2?"), new Nonterm("binop-expr")])
  ...
  g.addRule("inst-expr", [new Nonterm("expr"), new Token("LANGLE"), new Nonterm("ann"), new Nonterm("inst-expr_I3*"), new Token("RANGLE")])
